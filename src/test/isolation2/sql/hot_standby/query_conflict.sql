...
-1S: select max(confl_bufferpin) > 0from gp_stat_database_conflicts where datname = 'isolation2-hot-standby';
...
-- SELECT below will create more recent local snapshot that does not conflit with
